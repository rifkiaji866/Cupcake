...
/**
 * [SummaryFragment] Kelas SummaryFragment yang digunakan untuk menampilkan hasil pesanan
 */
class SummaryFragment : Fragment() {

    // Mengikat atau menghubungkan FragmentSummary dengan SummaryFragment
    ...
    /**
     * Mengirim pesanan ke luar aplikasi/aplikasi lain
     */
    fun sendOrder() {
